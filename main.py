...
for each_files in image_path:
    ...
    if i == 1:
        # print("in")
        previousImg = {'frame': cv2.imread(os.path.join(path, each_files))[93:998, 625:1745], 'fileName': fileName}
    ...
    currentImg = {'frame': cv2.imread(os.path.join(path, each_files))[93:998, 625:1745], 'fileName': fileName}
