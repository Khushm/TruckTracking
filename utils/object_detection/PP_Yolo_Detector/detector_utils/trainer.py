...
from ppdet.engine.callbacks import Callback, ComposeCallback, LogPrinter, Checkpointer, WiferFaceEval, VisualDLWriter, \
    SniperProposalsGenerator
from ppdet.engine.export_utils import _dump_infer_config, _prune_input_spec

from ppdet.utils.logger import setup_logger

from utils.object_detection.PP_Yolo_Detector.detector_utils.visualizer import visualize_results
...
class Trainer(object):
    ...
    def _init_metrics(self, validate=False):
        ...
        if self.cfg.metric == 'COCO' or self.cfg.metric == "SNIPERCOCO":
            ...
            # EvalReader instead of self.datasets(which is TrainReader)
        ...
        for epoch_id in range(self.start_epoch, self.cfg.epoch):
            ...
            if validate and (self._nranks < 2 or self._local_rank == 0) \
                ...
                if not hasattr(self, '_eval_loader'):
                    # build evaluation datasets and loader
    ...
    def predict(self,
        ...
        anno_file = self.dataset.get_anno()
        clsid2catid, catid2nametrainer = get_categories(
        ...
        for outs in results:
            ...
            bbox_detection, class_detection, score_detection = [], [], []
            start = 0
            for i, im_id in enumerate(outs['im_id']):
                ...
                image, bbox_detection, class_detection, score_detection = visualize_results(
                    image, bbox_res, mask_res, segm_res, keypoint_res,
                    int(im_id), catid2nametrainer, draw_threshold)
