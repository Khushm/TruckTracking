...
def draw_bbox(image, im_id, catid2name, bboxes, threshold):
    ...
    for dt in np.array(bboxes):
        ...
        bbox_detection.append(bbox)
        class_detection.append(catid2name[catid])
        score_detection.append(score)
    ...
    return image, bbox_detection, class_detection, score_detection
